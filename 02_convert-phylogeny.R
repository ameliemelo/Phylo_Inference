...
phylo <- readRDS("data/tree-100k-bisse.rds") # change file name if needed
true_params <- readRDS("data/true-parameters-100k-bisse.rds") # same
...
saveRDS(sumstat, "data/sumstat-100k-bisse.rds")
...
saveRDS(cblv, "data/cblv-100k-bisse.rds")
...
saveRDS(df.ltt, "data/ltt-100k-bisse.rds")
...
saveRDS(graphs, "data/graph-100k-bisse.rds")
